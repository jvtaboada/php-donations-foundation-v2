...
<html lang="pt-BR">
    <head>
        ...
        <link rel = "shortcut icon" type = "imagem/x-icon" href = "/img/check-icone.png"/>
    ...
    <body class="processa-body">
        <div class="bcg-recibo">
            ...
            <p class="transacao-sucesso">
                Sua transação no valor de <b> R$ <?php echo number_format($valor,2,",",".")?> </b> foi enviada com sucesso para a instituição <?php echo $instituicao?>.
            </p>
